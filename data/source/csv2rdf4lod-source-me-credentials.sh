...
source /etc/prizms/iogds/ckan/datahub.io/csv2rdf4lod-source-me-for-ckan-credentials.sh
source /etc/prizms/iogds/triple-store/virtuoso/csv2rdf4lod-source-me-for-virtuoso-credentials.sh
